...
\begin{align}
 P(XY<N) = ∑\sum_{k=1}^{6} P(X=k) (F_Y(N/k)-P(Y=N/k))\\
 F_Y1(N/k) = F_Y(N/k)-P(Y=N/k)\\
 P(XY<N) = ∑\sum_{k=1}^{6} P(X=k) F_Y1(N/k)\\
...
\noindent P(XY $<$ N) = \\
 (1/6) F_Y1(N) + (1/6) F_Y1(N/2) + (1/6) F_Y1(N/3) + (1/6) F_Y1(N/4) + (1/6) F_Y1(N/5) + (1/6) F_Y1(N/6) \\
 
\noindent Calculation for N=9:\\
  
\noindent Using formulae (4) and (5)\\

\noindent P(XY $<$ 9) = (1/6) F_Y1(9) + (1/6) F_Y1(9/2) + (1/6) F_Y1(9/3) + (1/6) F_Y1(9/4) + (1/6) F_Y1(9/5) + (1/6) F_Y1(9/6) \\
 
\noindent P(XY$<$9)=(1/6)(1)+(1/6)(4/6)+(1/6)(2/6)+(1/6)(2/6)\\+(1/6)(1/6)+(1/6)(1/6)\\
